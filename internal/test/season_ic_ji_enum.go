...
var invalidSeason_Ic_JiValue = func() Season_Ic_Ji {
	var v Season_Ic_Ji
	for {
		if !slices.Contains(AllSeason_Ic_Jis, v) {
			return v
		}
		v++
	} // AllSeason_Ic_Jis is a finite set so loop will terminate eventually
}()
