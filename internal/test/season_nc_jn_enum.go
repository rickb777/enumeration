...
func (v Season_Nc_Jn) String() string {
	return v.toString(season_nc_jnEnumStrings, season_nc_jnEnumIndex[:])
}

func (v Season_Nc_Jn) toString(concats string, indexes []uint16) string {
	o := v.Ordinal()
...
func Season_Nc_JnOf(v int) Season_Nc_Jn {
	...
	// an invalid result
	return Spring_Nc_Jn + Summer_Nc_Jn + Autumn_Nc_Jn + Winter_Nc_Jn + 1
}
...
// a number. The input representation is determined by None. It is used by AsSeason_Nc_Jn.
//
// Usage Example
//
//	v := new(Season_Nc_Jn)
...
// a number. The input representation is determined by season_nc_jnMarshalTextRep. It wraps Parse.
...
func (v Season_Nc_Jn) MarshalJSON() ([]byte, error) {
	...
	return season_nc_jnMarshalNumber(v)
}
...
// the value is out of range but season_nc_jnMarshalTextRep != enum.Ordinal.
// This function can be replaced with any bespoke function than matches signature.
var season_nc_jnMarshalNumber = func(v Season_Nc_Jn) (text []byte, err error) {
