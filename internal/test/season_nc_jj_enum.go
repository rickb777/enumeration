...
var invalidSeason_Nc_JjValue = func() Season_Nc_Jj {
	var v Season_Nc_Jj
	for {
		if !slices.Contains(AllSeason_Nc_Jjs, v) {
			return v
		}
		v++
	} // AllSeason_Nc_Jjs is a finite set so loop will terminate eventually
}()
