...
var invalidSeason_Uc_JiValue = func() Season_Uc_Ji {
	var v Season_Uc_Ji
	for {
		if !slices.Contains(AllSeason_Uc_Jis, v) {
			return v
		}
		v++
	} // AllSeason_Uc_Jis is a finite set so loop will terminate eventually
}()
...
// season_uc_jiMarshalNumber handles marshaling where a number is required or where
// the value is out of range.
// This function can be replaced with any bespoke function than matches signature.
var season_uc_jiMarshalNumber = func(v Season_Uc_Ji) string {
