...
func (v Season_Ic_Jn) String() string {
	return v.toString(season_ic_jnEnumStrings, season_ic_jnEnumIndex[:])
}

func (v Season_Ic_Jn) toString(concats string, indexes []uint16) string {
	o := v.Ordinal()
...
func Season_Ic_JnOf(v int) Season_Ic_Jn {
	...
	// an invalid result
	return Spring_Ic_Jn + Summer_Ic_Jn + Autumn_Ic_Jn + Winter_Ic_Jn + 1
}
...
// a number. The input representation is determined by None. It is used by AsSeason_Ic_Jn.
...
// a number. The input representation is determined by season_ic_jnMarshalTextRep. It wraps Parse.
// The input case does not matter.
...
func (v Season_Ic_Jn) MarshalJSON() ([]byte, error) {
	...
	return season_ic_jnMarshalNumber(v)
}
...
// the value is out of range but season_ic_jnMarshalTextRep != enum.Ordinal.
// This function can be replaced with any bespoke function than matches signature.
var season_ic_jnMarshalNumber = func(v Season_Ic_Jn) (text []byte, err error) {
