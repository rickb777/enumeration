...
func (v Season_Ic_Ss) String() string {
	return v.toString(season_ic_ssEnumStrings, season_ic_ssEnumIndex[:])
}

func (v Season_Ic_Ss) toString(concats string, indexes []uint16) string {
	o := v.Ordinal()
...
func Season_Ic_SsOf(v int) Season_Ic_Ss {
	...
	// an invalid result
	return Spring_Ic_Ss + Summer_Ic_Ss + Autumn_Ic_Ss + Winter_Ic_Ss + 1
}
...
// a number. The input representation is determined by None. It is used by AsSeason_Ic_Ss.
...
// a number. The input representation is determined by season_ic_ssMarshalTextRep. It wraps Parse.
// The input case does not matter.
...
func (v Season_Ic_Ss) Value() (driver.Value, error) {
	...
	return v.toString(season_ic_ssSQLStrings, season_ic_ssSQLIndex[:]), nil
}
