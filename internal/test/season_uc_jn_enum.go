...
var invalidSeason_Uc_JnValue = func() Season_Uc_Jn {
	var v Season_Uc_Jn
	for {
		if !slices.Contains(AllSeason_Uc_Jns, v) {
			return v
		}
		v++
	} // AllSeason_Uc_Jns is a finite set so loop will terminate eventually
}()
