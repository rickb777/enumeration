...
var invalidSeason_Ic_TaValue = func() Season_Ic_Ta {
	var v Season_Ic_Ta
	for {
		if !slices.Contains(AllSeason_Ic_Tas, v) {
			return v
		}
		v++
	} // AllSeason_Ic_Tas is a finite set so loop will terminate eventually
}()
